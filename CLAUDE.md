...
Respect Island — native macOS companion for AI coding agents. Sits in the notch / top bar, monitors local sessions, surfaces permission and question events, and jumps back to the right terminal/IDE. Local-first, no server.
...
- Title: `Respect Island vX.Y.Z — Short English Title`. Installation section bilingual.
