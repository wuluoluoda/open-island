...
/// Installs/uninstalls Respect Island's managed `[[hooks]]` entries in
/// `~/.kimi/config.toml`.
///
...
public enum KimiHookInstaller {
    ...
    /// Respect Island / Vibe Island build.
    ...
    /// escape handling is unnecessary — Respect Island only ever writes paths,
