...
public struct HookHealthReport: Equatable, Sendable {
    ...
    public enum Issue: Equatable, Sendable, CustomStringConvertible {
        ...
        /// Other hooks detected alongside Respect Island hooks (informational).
...
public enum HookHealthCheck {
        ...
        for (_, eventValue) in hooks {
            ...
            for group in groups {
                ...
                for hook in hookEntries {
                    ...
                    // Only check Respect Island / Vibe Island commands
    ...
    /// Finds third-party (non-Respect Island) hook command names for display.
        ...
        for (_, eventValue) in hooks {
            ...
            for group in groups {
                ...
                for hook in hookEntries {
                    ...
                    // Skip Respect Island / Vibe Island hooks
    ...
    /// Checks whether any Respect Island managed hooks exist in a config file.
