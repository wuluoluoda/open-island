#!/bin/zsh
#
# Create a local self-signed code signing identity for Respect Island dev
...
IDENTITY_NAME="Respect Island Dev Local"
...
echo "you give Respect Island Dev will persist across rebuilds."
