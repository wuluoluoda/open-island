#!/bin/zsh
#
# Create a local self-signed code signing identity for Respect Island local
...
IDENTITY_NAME="Respect Island Local"
...
echo "you give Respect Island will persist across rebuilds."
