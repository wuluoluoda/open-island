...
```
我在使用 Respect Island (https://github.com/Octane0411/open-vibe-island) 时遇到了问题。
...
```
我想为 Respect Island (https://github.com/Octane0411/open-vibe-island) 提一个功能建议。
...
Respect Island 是一个原生 macOS 应用，作为 AI 编程代理的桌面伴侣。它驻留在刘海/顶栏区域，监控本地代理会话、展示权限请求、回答问题，并提供"跳转回"对应终端上下文的能力。完全本地运行，无需服务端。
