...
Respect Island 基于 [Octane0411/open-vibe-island](https://github.com/Octane0411/open-vibe-island) 修改，并按 GNU General Public License v3.0 发布。这个仓库由 [wuluoluoda](https://github.com/wuluoluoda) 作为独立 GPLv3 项目维护，重点面向高频本地 Codex 工作流。
