...
- The script creates `output/package/Respect Island.app`.
...
- The script also creates `output/package/Respect Island.zip` for local sharing or later notarization.
...
### "Respect Island is damaged and can't be opened"
