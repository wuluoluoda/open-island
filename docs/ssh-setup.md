...
Connect Respect Island to Claude Code running on a remote server over SSH.
...
┌──────────────┐    SSH tunnel     ┌────────────────────┐
│ Respect Island  │◀═══════════════▶│ Unix socket (fwd)  │
...
- Respect Island running on your Mac
...
1. Make sure Respect Island is running on your Mac
2. SSH to the remote with socket forwarding enabled
3. Run Claude Code on the remote — sessions should appear in the Respect Island overlay
...
- Make sure Respect Island is running locally before establishing the SSH connection
